...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER(ORDER BY penjualan_detail_id asc) AS no, a.penjualan_detail_id,
                b.nama_produk, b.harga_jual,a.qty as jumlah, b.harga_jual*a.qty as sub_total FROM penjualan_detail a, produk b
...
if (isset($_POST['BtnPrint'])) {
    ...
    header("Location: adm_sale_print.php");
}
?>
                    ...
                    <div class="forms_content_box">
                        ...
                        <div class="forms_content_box_toolbar">
                            <div class="forms_content_box_toolbar_item">
                                <!-- <form action="adm_sale_view.php" method="POST">
                                    ...
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <?php for ($i = 1; $i <= $totoalPages; $i++) : ?>
                                            <li class="page-item <?php if ($page == $i) {
                                                ...
                                                <a class="page-link" style="font-size:13px;" href="adm_sale_view.php?page=<?= $i; ?>"> <?= $i; ?> </a>
                                            </li>
                                        <?php endfor; ?>
