...
// Get total records
$stmt = $conn->prepare("SELECT count(penjualan_id) AS id FROM penjualan where user_id=:user_id");
$stmt->execute($arrData);
...
if (isset($_POST['BtnDetail'])) {
    ...
    header("Location: csh_sale_view.php");
}
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                        <!-- <div style="display:flex;flex-direction:row;"> -->
                                                            ...
                                                            <input type="text" hidden name="id" value=<?php echo $penjualan_id; ?> />
                                    ...
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <?php for ($i = 1; $i <= $totoalPages; $i++) : ?>
                                            <li class="page-item <?php if ($page == $i) {
                                                ...
                                                <a class="page-link" style="font-size:13px;" href="csh_sale.php?page=<?= $i; ?>"> <?= $i; ?> </a>
                                            </li>
                                        <?php endfor; ?>
